...
const CodingJourney = () => {
  const stats = [
    { label: 'Problems Solved', value: '60+', icon: <Hash className="h-6 w-6 text-primary" /> },
    { label: 'Streak Days', value: '50+', icon: <CalendarDays className="h-6 w-6 text-accent" /> },
    { label: 'Contests', value: '2+', icon: <TrendingUp className="h-6 w-6 text-accent2" /> },
    { label: 'GitHub Repos', value: '13+', icon: <Github className="h-6 w-6 text-primary" /> },
  ];
  ...
  const platforms = [
    {
      name: 'LeetCode',
      username: 'Pramodh3',
      link: 'https://leetcode.com/u/pramodh3/',
      highlight: 'Daily Coding & 60+ Problems Solved',
    },
    {
      name: 'GitHub',
      username: '@PramodhKumar3',
      link: 'https://github.com/PramodhKumar3',
      highlight: 'Spring Boot Projects, LeetCode Solutions & System Designs',
    },
    // {
    //   name: 'GeeksforGeeks',
      ...
      <div className="section-container">
        ...
        >
          ...
          <div className="w-full aspect-video min-h-[300px]">
            <iframe
              src="https://leetcard.jacoblin.cool/Pramodh3?theme=dark&font=Fira%20Code&ext=heatmap"
