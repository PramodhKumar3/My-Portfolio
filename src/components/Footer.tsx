...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', url: 'https://github.com/PramodhKumar3' },
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/tamminaina-pramodh-kumar-6433a4242' },
    { name: 'Email', url: 'mailto:tamminainapramodhkumar6@gmail.com' },
    { name: 'Instagram', url: 'https://www.instagram.com/its__me_pramodh03/' }
  ];
    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8 text-sm">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          {/* About section */}
          <div>
            <h3 className="text-lg font-bold mb-4">Pramodh Kumar</h3>
            <p className="text-gray-400 mb-6">
              Backend Developer | Java & Spring Boot Enthusiast | System Design, DSA & Microservices Practitioner.
            </p>
            <p className="text-gray-400 mb-6">Always eager to connect and collaborate!</p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center">
          <p className="text-gray-500">
            &copy; {currentYear} Pramodh Kumar. All rights reserved.
          </p>

          <p className="text-gray-500 flex flex-col sm:flex-row items-center gap-1 sm:gap-2">
            <span>Built with ❤️ by Tamminaina Pramodh Kumar</span>
            <span>|</span>
