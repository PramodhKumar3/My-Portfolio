...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      icon: <Mail className="h-6 w-6 text-primary" />, title: 'Email', value: 'tamminainapramodhkumar6@gmail.com', link: 'mailto:tamminainapramodhkumar6@gmail.com'
    },
    {
      icon: <Phone className="h-6 w-6 text-primary" />, title: 'Phone', value: '+91 9398039742', link: 'tel:+9193998039742'
    },
    {
      icon: <MapPin className="h-6 w-6 text-primary" />, title: 'Location', value: 'Hyderabad, Telangana', link: '#'
    }
  ];

  const socialLinks = [
    { name: 'LinkedIn', icon: <Linkedin className="h-5 w-5" />, url: 'https://www.linkedin.com/in/tamminaina-pramodh-kumar-6433a4242/' },
    { name: 'GitHub', icon: <Github className="h-5 w-5" />, url: 'https://github.com/PramodhKumar3' },
    { name: 'Instagram', icon: <Instagram className="h-5 w-5" />, url: 'https://www.instagram.com/its__me_pramodh03/' }
  ];
