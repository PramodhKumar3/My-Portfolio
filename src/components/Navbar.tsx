...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-50 bg-white dark:bg-gray-900 backdrop-blur-md transform transition-transform duration-300 ease-in-out
