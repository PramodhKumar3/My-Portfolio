    ...
    >
      ...
      <div className="section-container flex flex-col items-center text-center">
        ...
        >
          ...
          Passionate Software Engineer with hands-on experience in Java, Spring Boot, Microservices, and system design — building scalable and reliable backend platforms.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 w-full sm:w-auto">
            ...
            <a 
              href="https://drive.google.com/file/d/1_JpyEWsX4Gdvi8kbFpyTVDrZKj-j1Sua/view?usp=sharing" 
              target="_blank"
              rel="noopener noreferrer"
